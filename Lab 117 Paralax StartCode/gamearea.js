function GameArea() {
  ...
  this.wrapperDiv.setAttribute("style", " background-color:yellow; border: 5px solid black; width:1100px; height:200px;");
  // create tileMenuDiv
  this.tileMenuDiv = document.createElement("div");
  this.wrapperDiv.appendChild(this.tileMenuDiv)
  this.tileMenuDiv.setAttribute("style", " background-color:green; width:1100px; height:100px;float:left;");


  //!create left pannle 
  this.leftPannleDiv = document.createElement("div");
  this.wrapperDiv.appendChild(this.leftPannleDiv);
  this.leftPannleDiv.setAttribute("style", " background-color:red; width:100px; height:700px;float:left;")
  ...
  this.canvasDiv.setAttribute("style", " background-color:pink; width:1000px; height:700px;float:left;");
